...
- 算法服务
  - OCR、文本分析、后结构化处理、智能语音、图像识别
  - 分析引擎、推荐引擎、规则引擎、用户画像、分类预测、标签管理、IDMapping
...
- 数据交换平台
- 数据规范、数据标准
- 数据模型（https://www.jianshu.com/p/f8a7c33709b3）
- 数据目录、数据授权
- 数据服务（API、消息、文件、其他）
- 数据标签
- 数据开发工具
...
http://www.sohu.com/a/57919530_115128
- 服务总线（流程引擎、规则引擎、缓存服务、作业管理服务、报表服务、消息服务、日志服务、通知服务、文件服务……）
- 底层SQL质量评审
- 智能运维
- docker k8s
- 大规模的ElasticSearch集群
...
https://blog.csdn.net/Peter_Changyb/article/details/85844048
-
